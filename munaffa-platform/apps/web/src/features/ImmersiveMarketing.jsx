...
const pages={
 home:{eyebrow:'RESTAURANT PROFIT OS',title:'Every dish has a story. Now you know the Munaffa.',body:'A connected restaurant operating system that follows an order from discovery to table, kitchen, stock, payment and real profit.',accent:'#b9ef83'},
 platform:{eyebrow:'ONE LIVING SYSTEM',title:'The restaurant becomes one connected world.',body:'Customer, waiter, kitchen, stock, supplier and owner work from the same operational truth.',accent:'#e9c37b'},
 profit:{eyebrow:'PROFIT OS',title:'Watch every rupee move.',body:'Revenue separates into ingredient cost, discounts, waste, fees and contribution — with evidence behind every alert.',accent:'#b9ef83'},
 operations:{eyebrow:'LIVE OPERATIONS',title:'Run the floor like a control room.',body:'Tables, orders, KDS, waiter requests, approvals and service timing move together in real time.',accent:'#7bdcff'},
 inventory:{eyebrow:'INVENTORY INTELLIGENCE',title:'From a 25 kg sack to the last gram on a plate.',body:'Purchase, normalize, recipe, count, waste and forecast without pretending chefs work like robots.',accent:'#ffc86f'},
 guest:{eyebrow:'GUEST EXPERIENCE',title:'Digital when useful. Human when better.',body:'Browse, book, scan, order, call a waiter or pay — without forcing a customer into a QR-only experience.',accent:'#ff9b7e'},
 ai:{eyebrow:'MUNAFFA INTELLIGENCE',title:'AI that explains before it recommends.',body:'Detect variance, forecast demand, surface churn risk and show the numbers behind the recommendation.',accent:'#aa96ff'},
 discovery:{eyebrow:'DISCOVERY',title:'Find nearby restaurants without losing the restaurant relationship.',body:'Search restaurants, cafés and hotel dining, book tables and order direct from one consumer experience.',accent:'#71e0c0'},
